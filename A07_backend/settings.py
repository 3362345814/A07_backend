"""
Django settings for A07_backend project.
...
SECRET_KEY = 'django-insecure-isvx9jku7%=hnx12qjjz-b7(s4&9r)9b@ujbbg1et3_1apt!x5'
...
WSGI_APPLICATION = 'A07_backend.wsgi.application'
...
# 在文件合适位置添加
OSS_CUSTOM_DOMAIN = os.getenv('OSS_CUSTOM_DOMAIN')  # 替换为实际绑定的域名
